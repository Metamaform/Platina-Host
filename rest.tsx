...
function Shop({  onPlayUpgrade, onPlayCraft, onPlayMines, giftsDb, pricesLoaded }: { onPlayUpgrade: () => void, onPlayCraft: () => void, onPlayMines: () => void, giftsDb: any[], pricesLoaded: boolean }) {
          ...
          <main className="flex-1 overflow-y-auto pt-[80px] pb-[120px] px-5 scrollbar-hide relative">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="w-full"
              >
                {activeTab === 'shop' && <Shop onPlayUpgrade={() => setActiveGame('upgrade')} onPlayCraft={() => setActiveGame('craft')} onPlayMines={() => setActiveGame('mines')} giftsDb={giftsDb} pricesLoaded={pricesLoaded} />}
